...
var secret = constants_1.JWT_CONFIG.secret, expiresIn = constants_1.JWT_CONFIG.expiresIn;
var AuthModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                users_module_1.UsersModule,
                passport_1.PassportModule,
                jwt_1.JwtModule.register({ secret: secret, signOptions: { expiresIn: expiresIn } }),
            ],
            providers: [
