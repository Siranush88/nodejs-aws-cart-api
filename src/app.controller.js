...
var AppController = function () {
    ...
    var AppController = _classThis = /** @class */ (function () {
        function AppController_1(authService) {
        ...
        AppController_1.prototype.login = function (req) {
        ...
        AppController_1.prototype.getProfile = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, {
                            statusCode: common_1.HttpStatus.OK,
    ...
    (function () {
        ...
        _healthCheck_decorators = [(0, common_1.Get)(['', 'ping'])];
        _login_decorators = [(0, common_1.UseGuards)(auth_1.LocalAuthGuard), (0, common_1.Post)('api/auth/login')];
        _getProfile_decorators = [(0, common_1.UseGuards)(auth_1.BasicAuthGuard), (0, common_1.Get)('api/profile')];
